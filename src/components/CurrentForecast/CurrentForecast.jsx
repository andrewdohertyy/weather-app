...
const CurrentForecast = ({ currentWeather, time }) => {
  ...
  return (
    <div className="current-forecast" id={timeID}>
      ...
      <h1 className="current-forecast__location child">
        {location}, {country}{" "}
      </h1>
      <h2 className="current-forecast__description child">
        Its {condition} outside today.
      </h2>
      <h2 className="current-forecast__header child ">
        {" "}
        {tempc}°C or {tempf}°F{" "}
      </h2>
    </div>
